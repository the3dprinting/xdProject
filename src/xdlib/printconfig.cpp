...
PrintConfigDef::build_def() {
    ...
    Options["bridge_acceleration"].sidetext = "mm/s2";
    ...
    Options["default_acceleration"].sidetext = "mm/s2";
    ...
    Options["first_layer_acceleration"].sidetext = "mm/s2";
    ...
    Options["infill_acceleration"].sidetext = "mm/s2";
    ...
    Options["max_volumetric_speed"].sidetext = "mm3/s";
    ...
    Options["perimeter_acceleration"].sidetext = "mm/s2";
    ...
    Options["solid_infill_below_area"].sidetext = "mm2";
