...
{
    if (points.empty()) qDebug("Empty point set supplied to BoundingBoxBase constructor");
...
{
    if (points.empty()) qDebug("Empty point set supplied to BoundingBox3Base constructor");
    typename std::vector<PointClass>::const_iterator it = points.begin();
